...
Collections created:
  ...
  investing    -> <memory-root>/investing     (Investing notes and research)
EOF
}
...
investing|$MEMORY_ROOT/investing|Investing notes and research
EOF
...
echo "  investing    -> $MEMORY_ROOT/investing"
